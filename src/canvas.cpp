...
void
Canvas::updateImg(SDL_Texture* texture, SDL_Rect* destRect)
{
    SDL_RenderClear( m_window->renderer() );
    SDL_RenderCopy( m_window->renderer(), texture, NULL, destRect );
    SDL_RenderPresent( m_window->renderer() );
}
